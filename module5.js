...
let brian = new myDogConst( // Step 5: Create the object named myDogConst using the constructor
  "Brian",
...
brian.myGreeting(); // Step 6: Call the method to display the dog's greeting
